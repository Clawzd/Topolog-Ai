...
export default function ContextMenu({ x, y, target, onAction, onClose }) {
  ...
  const Item = ({ icon: Icon, label, action, danger, disabled, divider }) => {
  ...
  return (
    <div
      ref={ref}
      style={style}
      className="bg-card/98 backdrop-blur-md border border-border rounded-xl shadow-2xl shadow-black/50 p-1.5 w-48 animate-in fade-in zoom-in-95 duration-100"
