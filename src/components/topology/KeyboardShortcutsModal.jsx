...
const ROWS = [
  ...
  ['Export hub', 'Ctrl+E'],
  ['AI generate (when panel open)', 'Ctrl+Enter'],
  ['Nudge selection', 'Arrow 16px · Shift+Arrow 1px (v3)'],
  ['Label / rename', 'L (node or link selected)'],
  ['Undo', 'Ctrl+Z'],
  ...
  ['VLAN trunk / AP supported lists', 'Properties panel (link or AP selected)'],
  ['Room floor (multi-floor RF)', 'Room selected → Smart zone → Floor'],
